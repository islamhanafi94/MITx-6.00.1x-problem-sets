...
def getWordScore(word, n):
    ...
    for letter in word.lower():
        letterScoreSum += SCRABBLE_LETTER_VALUES[letter]

    score = letterScoreSum * len(word) + 50 \
        if len(word) == n else letterScoreSum * len(word)
...
def isValidWord(word, hand, wordList):
    ...
    """
    # Ditionary for the word to be compared with hand
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    while calculateHandlen(hand):
        ...
        # Otherwise (the word is valid):
            ...
            print(
                "{} earned {} points. Total: {} points.".format(userWord, wordScore, totalScore))
            print()
            # Update the hand
